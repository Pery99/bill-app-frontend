  ...
  const getStartedSteps = [
    {
      ...
      description:
        "Sign up in less than 2 minutes with your email and basic information",
      icon: UserGroupIcon,
    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 pb-16 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Experience lightning-fast bill payments with ShabanExpress. Pay for
            airtime, data, TV, and electricity bills instantly.
          </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              Three simple steps to start managing all your bill payments in one
              place
            </p>
          </div>
            ...
            {getStartedSteps.map((step, index) => (
              <div key={step.number} className="relative">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 relative">
                  {/* Numbered badge */}
                  <div
                    className={`absolute -top-4 left-8 h-8 px-3 flex items-center justify-center rounded-full bg-gradient-to-r ${step.color} text-white font-bold text-sm`}
                  >
                    {step.number}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <div
                  className={`${service.color} rounded-2xl p-4 relative mb-6 transform group-hover:scale-110 transition-transform`}
                >
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-24 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-lg text-gray-600 leading-relaxed">
                Experience the future of bill payments with our innovative
                platform. We've built the most reliable solution for all your
                payment needs.
              </p>
            </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Join thousands of Nigerians who trust ShabanExpress for their daily
            transactions
          </p>
          <Link to="/register" className="btn-primary">
            Get Started Now
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">ShabanExpress</h3>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>
            © {new Date().getFullYear()} Shaban express. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
